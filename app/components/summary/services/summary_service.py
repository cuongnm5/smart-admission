...
from ..dto.student_profile import StudentProfile
...
class MatchingEngine:
    ...
    def _build_analysis(
        ...
        if student.academic.test_scores.sat:
            test_scores_summary.append(
                {
                    "type": "SAT",
                    "score": student.academic.test_scores.sat.total,
                }
            )
        if student.academic.test_scores.act:
            test_scores_summary.append(
                {
                    "type": "ACT",
                    "score": student.academic.test_scores.act.composite,
                }
            )
        ...
        analysis = {
            "student": {
                "name": student.name,
                "gpa": student.academic.weighted_gpa(),
                "test_scores": test_scores_summary,
